...
**Per-page editorial register is intentionally not described here.** Each page carries its own form; meet it without preconception. Structural reference lives in § Repository Structure.
