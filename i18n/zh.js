...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    guide: {
      ...
      tipsA1: '<p>VAS 是一款 macOS 截圖與圖片處理工具，整合 OCR 文字辨識、隱私遮蔽、QR Code 掃描、點線面標注、裁切圖片、智慧導線排版、批次轉檔、浮水印，支援多螢幕操作。VAS Pro（Tauri · App Store · 9.99 美元）+ VAS Classic（Electron · 免費）兩種選擇。</p><p>它與其他截圖工具不同的地方：VAS 是「用 VAS 自己開發出來的 VAS」——專為人機協作設計，截下的圖標注後能直接交給 AI 讀懂，不希望被 AI 拿去訓練的隱私資訊也可一鍵遮蔽。</p>',
      ...
      tipsA6: '<p>截一張要分享的圖、單純註記——macOS 內建已經夠用。要錄影、要連續快照、要做使用手冊——Snagit / CleanShot X 是成熟選擇。</p><p>VAS 解決的是不一樣的問題。當你需要把畫面交給 AI 讀懂、把不希望被 AI 拿去訓練的隱私先遮起來、整個過程還要像水流一樣輕快——這是 VAS 從第一天就在優化的場景。</p><p>你不會用 VAS 取代 Snagit，就像 Snagit 也取代不了 VAS。</p>',
      allVersions: '全版本',
