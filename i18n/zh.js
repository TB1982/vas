...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    guide: {
      ...
      blP3: '而當你有事要找它時：',
      blLi1: '<strong>拖曳圖片靠近</strong><span class="g-badge-a" style="margin:0 4px 0 6px">全版本</span>——工具列像捕蠅草一樣張開，接住你拖過來的圖。放開的瞬間，圖直接進編輯器；如果你剛剛還在編輯別的東西，它會收納那張、直接展開編輯器繼續。',
      blLi2: '<strong>複製網址靠近</strong><span class="g-badge-t" style="margin:0 4px 0 6px">Tauri 專屬</span>——呼吸燈張開，跳出 toast：「檢測到 ⟨網址⟩—點擊開始截圖」。點一下就開始網頁截圖流程。',
      blLi3: '<strong>從瀏覽器複製圖片</strong><span class="g-badge-t" style="margin:0 4px 0 6px">Tauri 專屬</span>——跳出 toast 問你「貼上圖片」，你說好就直接進編輯器。',
      blNoteLabel: '召喚',
