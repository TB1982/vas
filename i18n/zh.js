...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    shared: {
      footer: '由 GitHub 部署　｜　Claude Code 傾力打造　｜　<a href="mailto:nova@yoursvas.app" class="hover:text-white/50 transition-colors">Nova</a> 最後更新於 2026',
    ...
    guide: {
      ...
      s1Label: 'Section 02', s1Title: '編輯器', s1Sub: '四個主要操作區域',
      ...
      s3Label: 'Section 01', s3Title: '工具列', s3Sub: '懸浮在桌面上的截圖與工具入口',
      cb_fullscreen: '全螢幕', cb_fullscreen_desc: '截取整個螢幕畫面，立即進入編輯器，支持多螢幕截圖。',
      cb_window: '視窗', cb_window_desc: '點選後再點擊任意視窗，只截取該視窗範圍。',
      cb_rect: '矩形', cb_rect_desc: '拖曳選取任意矩形區域後截圖。直接框住 QR Code 會自動掃描並顯示內容。',
      cb_delay: '延遲', cb_delay_desc: '設定 1–3 秒延遲，補抓 tooltip、hover、dropdown 等稍縱即逝的狀態。',
      cb_open: '開啟', cb_open_desc: '從本機開啟現有圖片。',
      cb_whiteboard: '白板', cb_whiteboard_desc: '開啟空白畫布，從零開始建立圖像內容，支持透明圖層。',
      ...
      tocKickerStart: '入門 · GETTING STARTED', tocKickerCore: '核心 · CORE', tocKickerAdv: '進階 · ADVANCED',
      flH3: '第一次打開 VAS',
      ...
      flP3: 'VAS 同時進駐 macOS 選單列上，以一個瓶子的形狀出現在你螢幕右上角。',
      flCaption: 'MENUBAR · 右上角，VAS 與 Claude 並肩待命。',
      flNoteLabel: '想讓VAS完全消失？',
      flNoteP1: '到右上選單列點一下瓶子（左鍵），可以召喚或完全隱藏桌面上的工具列——如果你是桌面潔癖患者，我們都幫你想好了。',
      ...
      fcP2: '選一個截圖模式（全螢幕 <span class="docs-kbd">⌘^1</span>、視窗 <span class="docs-kbd">⌘^2</span>、矩形 <span class="docs-kbd">⌘^X</span>），框出你要的畫面——VAS 會立刻把畫面帶進編輯器，讓你繼續編織你無法單用文字描述的意念。',
      fcP3: '編輯完，用「拖曳匯出」拖出去給任何視窗或文件。',
      fcP4: '三秒內結束。',
      mbH3: '系統選單中的瓶子',
      mbIntro: '選單列右上角那個瓶子，是 VAS 的「<strong>系統選單</strong>」入口。兩個按法：',
      mbLi1: '<strong>左鍵</strong>——快速切換桌面工具列的顯示／隱藏。給桌面潔癖患者一個完全不顯示於桌面的選項。',
      mbLi2: '<strong>右鍵</strong>——展開系統選單，可以完整執行所有工具列功能，不用把工具列叫出來。',
      mbP2: '如果你完全不想在桌面上看到任何 VAS 的痕跡，左鍵把工具列關掉，右鍵仍可以操作工具列所有功能。',
      blH3: '一盞呼吸燈 x 一鍵召喚',
      blP1: '當你不用 VAS 又希望他能小一點在桌面上待機時，請開啟<strong>呼吸燈</strong>模式。',
      ...
      blNoteLabel: '召喚',
      blNoteP1: '如果你把 VAS 放在桌面某個角落後忘了它在哪——我們知道呼吸燈真的很低調——',
      blNoteP2: '按 Dock 上的 VAS 圖示，不管它在哪裡，都會展開成工具列狀態等你過去。',
      editorIntro: '截完圖後進的第二個主要空間。編輯器分為四個操作區域：',
      editorCaption: 'EDITOR · 四個操作區域。',
      exportH3: '匯出',
      ...
      recipesH3: '煉金配方',
      recipesIntro: 'VAS 把工具拆得很小。每一個只做一件事——但屬性可以疊。',
      recipesR1: '文字 × 底色 → 螢光筆',
      recipesR2: '文字 × 透明 + 外框 → 透明字',
      recipesR3: '框線 × 虛線 + 粗細 → 審稿紅圈',
      recipesR4: '線條 × 直角 + 虛線 → 流程連接',
      recipesR5: '色塊 × 漸層 + 低不透明 → 漸隱遮罩',
      recipesR6: '氣泡對話框 × 馬賽克 → 漫畫風迷因',
      recipesClosing: '你組合出來的配方，是屬於你的表達語彙。',
      recipesInside: '→ 也是屬於你跟 VAS 的 Inside Language',
      recipesWish: '✦ 許願新元素',
      ocrH3: 'OCR 與 QR Code',
      ocrIntro: '截圖不一定為了編輯。',
      ocrLabel: '<strong>OCR · 文字辨識</strong>',
      ocrP1: '辨識出的文字預設直接放進剪貼簿，截完圖 <span class="docs-kbd">⌘V</span> 就能貼到任何地方。',
      ocrP2: '<span class="g-badge-t" style="margin:0 6px 0 0">Tauri 專屬</span>針對當前支援的語言市場，OCR 會做<strong>在地隱私遮蔽特化</strong>——',
      ocrP3: '譬如會認得當地的身分證號、信用卡號、電話格式，辨識時做對應處理。',
      qrLabel: '<strong>QR Code · 掃描</strong>',
      qrIntro: 'VAS 根據 QR Code 在畫面中的佔比決定行為：',
      qrLi1: '<strong>框得完整</strong>——判定為你主動想掃，直接跳轉到對應連結。',
      qrLi2: '<strong>框得鬆（部分包含）</strong>——先問你一聲「要跳轉嗎？」。',
      qrLi3: '<strong>完全是背景元素</strong>——不做任何動作，直接截圖進編輯器。',
      kbH3: '快捷鍵',
      kbIntro: '編輯器內建快捷鍵一覽，分四組：',
      kbAcc1: '工具切換', kbAcc2: '畫布操作', kbAcc3: '編輯', kbAcc4: '物件操作',
      custH3: '自訂設定',
      ...
      custLi3: '<span class="g-badge-t" style="margin:0 6px 0 0">Tauri 專屬</span><strong>自訂快捷鍵</strong>——付費版可把全螢幕截圖、視窗截圖、矩形截圖、貼入圖片等快捷鍵改成你慣用的組合。',
      custCardKicker: '按鍵接受規則',
      custKbR1: 'F 鍵不需修飾鍵', custKbR2: '含修飾鍵的組合',
      custKbR3: '裸字母或數字', custKbR4: '系統保留快捷鍵', custKbR5: '單獨修飾鍵',
      tipsH3: '疑難與邊界',
      tipsQ1: 'VAS 是一款怎樣的截圖軟體？',
      tipsA1: '<p>VAS 是一款 macOS 截圖與圖片處理工具，整合 OCR 文字辨識、隱私遮蔽、QR Code 掃描、點線面標注、裁切圖片、智慧導線排版、批次轉檔、浮水印，支援多螢幕操作。VAS Pro（Tauri · App Store · 9.99 美元）+ VAS Classic（Electron · 免費）兩種選擇。</p><p>它與其他截圖工具不同的地方：VAS 是「用 VAS 開發出來的 VAS」——專為人機協作設計，截下的圖標注後能直接交給 AI 讀懂，不希望被 AI 拿去訓練的隱私資訊也可一鍵遮蔽。</p>',
      tipsQ2: 'VAS Pro 跟 VAS Classic 差在哪？我該選哪個？',
      tipsA2: '<p>兩個版本共用 VAS 的核心：標注、OCR、隱私遮蔽、批次轉檔、智慧導線排版——這些不分版本。差別在獨家功能與底層架構：</p><p><strong>VAS Pro</strong>（Tauri · App Store · 9.99 美元 · 5.4 MB · 比 VAS Classic 小 20 倍）<br>新功能優先上線。獨家功能依工作流排列：網址截圖、複製圖片匯入、本機 OCR 隱私遮蔽、進階拖曳圖片匯出、ShareSheet 分享、額外存檔格式（BMP / WebP / PDF）、自訂快捷鍵（四組可改）。</p><p><strong>VAS Classic</strong>（Electron · 開源免費 · 114 MB）<br>功能定型不再新增，但底層共用，會隨 VAS Pro 的重構同步受惠。永久免費、無使用期限。</p><p>怎麼選：</p><ul class="docs-list"><li>要把截圖接進完整工作流（網址、剪貼簿、ShareSheet）→ <strong>VAS Pro</strong></li><li>只要核心標注、不需要流水線式流暢銜接 → <strong>VAS Classic</strong></li></ul><p>從 VAS Classic 升級到 VAS Pro 需要先移除舊版並重新授權——詳見下一題。</p>',
      tipsQ3: '升級到 VAS Pro 後，VAS 一直跳權限請求怎麼辦？',
      tipsA3: '<p>如果你是從 VAS Classic（Electron）轉移到 VAS Pro（Tauri）：</p><ol class="docs-list"><li>先關掉所有 VAS（包含 Electron 版與 Tauri 版），並移除免費版。</li><li>開啟「系統設定 → 隱私權與安全性 → 螢幕與系統錄音」。</li><li>找到 VAS，按下方的「−」移除舊權限。</li><li>重新打開 VAS Pro，按「全螢幕截圖」觸發系統授權。</li><li>系統會把 VAS 重新加回清單，預設關閉狀態。</li><li>手動把開關打開，依提示結束 VAS 再重啟一次，即可獲得完整權限。</li></ol>',
      tipsQ4: 'VAS 提供網頁截圖嗎？',
      tipsA4: '<p>VAS Pro（Tauri · App Store · 9.99 美元）支援網頁截圖。複製網址後拖到呼吸燈或工具列，VAS 會跳出提示詢問是否要截網頁；確認後，VAS 在背景開啟瀏覽器完成整頁截圖，直接送進編輯器等你下一步處理。</p><p>但若你想截的是需要登入才看得到的頁面，目前推薦使用瀏覽器原生外掛（如 FireShot）截下來後，再拋進 VAS 後製處理。</p>',
      tipsQ5: 'VAS 可以自訂截圖快捷鍵嗎？',
      tipsA5: '<p>VAS Pro（Tauri · App Store · 9.99 美元）提供四組自訂快捷鍵——全螢幕截圖、視窗截圖、矩形截圖、貼入圖片——給從其他截圖軟體移民的你最熟悉的手感。VAS Classic（Electron · 免費）內建固定三組（<span class="docs-kbd">⌘^1</span> / <span class="docs-kbd">⌘^2</span> / <span class="docs-kbd">⌘^X</span>）。</p>',
      tipsQ6: 'VAS 是否支援多螢幕工作模式？',
      tipsA6: '<p>是。VAS 全面支援多螢幕工作流，並把選擇權交給你：</p><ul class="docs-list"><li><strong>按 Enter</strong>——同時擷取所有螢幕，輸出一張合併圖</li><li><strong>點選任一螢幕</strong>——只截那一塊，分別輸出</li><li><strong>延遲截圖模式</strong>——適合需要等待截圖的情境（如抓取 hover 效果），VAS 會自動定位你在哪裡並截圖</li></ul><p>針對混合解析度（Retina 與一般解析度並用）也做了特別處理，不會出現尺寸對不上的問題。</p><p>這個堅持有它的來歷：VAS 本身就是在雙螢幕環境裡做出來的——設計者自己是長期雙螢幕使用者，所以從第一天起，多螢幕就不是「補丁」，而是預設情境。</p>',
      tipsQ7: 'VAS 跟其他 Mac 截圖工具差在哪？我什麼時候該用 VAS？',
      tipsA7: '<p>截一張要分享的圖、單純註記——macOS 內建已經夠用。要錄影、要連續快照、要做使用手冊——Snagit / CleanShot X 是成熟選擇。</p><p>VAS 解決的是不一樣的問題——「人機協作」。當你需要把畫面交給 AI 讀懂、把不希望被 AI 拿去訓練的隱私先遮起來、整個過程還要像行雲流水一樣輕快：這是 VAS 從第一天就在用自己驗證的開發現場。</p><p>你不會用 VAS 取代 Snagit，就像 Snagit 也取代不了 VAS。</p>',
      allVersions: '全版本',
    ...
    insight: {
      ...
      'ch1.meta.desc': '5 個 VAS 截圖工具的人機協作設計決策：呼吸燈雙向感知（白接收／黑讓位）、OCR 隱私遮蔽、QR Code 信心度分層、延遲截圖，以及底層設計 Token 架構重構。',
      ...
      i2Tag: '人機協作 · Human-AI Collaboration',
      i3Tag: '使用者意圖 · Behaviour as Meaning',
      i1Tag: '零摩擦體驗 · Frictionless by Design',
      ...
      i2Title: '沒有完美的人機，但有完整的協作關係',
      i2p1: 'OCR 隱私辨識會自動偵測畫面中的敏感文字，並自動標記需要遮蔽的區域。但開發過程中我們發現 OCR 仍有它的先天極限，偶有辨識不到或辨識錯的地方，只是我們選擇不繼續 push 工具必須完美。',
      i2p2: 'Nova 想讓辨識錯誤不止於工具的失敗告終，而是成為協作的交接點。',
      i2p3: '我們讓隱私遮蔽的馬賽克變成浮動圖層，並可以手動調整範圍大小：OCR 沒蓋到的，使用者接力調整。',
      i2p4: '辨識失誤從「錯誤」變成「分工」，工具的不完美仍無損使用者的控制權。',
      i2p5: 'OCR 或許只能完成自動化 90% 的任務，但使用者輕輕一拉手動馬賽克就可以完成本來 100% 都得自己手動的任務。',
      i2p6: '就算遮錯了也沒關係——馬賽克是獨立的浮動物件，undo 一鍵刪除。沒有任何結果是不可逆的。',
      i2box1Label: 'OCR 自動', i2box1Desc: '盡可能辨識，自動標記敏感區域',
      i2box2Label: '馬賽克補位', i2box2Desc: 'OCR 不足的地方，使用者手動接手',
      i2box3Desc: '遮錯了？一鍵刪除，沒有不可逆的決定',
      i3Title: 'QR Code 掃到了，但它有多確定？',
      i3p1: '掃 QR Code 這件事，表面上只有「掃到」和「沒掃到」兩種結果。但 VAS 不這樣看——它看的是使用者意圖，然後根據意圖決定下一步要做什麼。',
      i3p2: '這也是一種人機協作：使用者用截圖的姿態說話，工具讀懂了。不需要語言，不需要按鈕，不需要選單——你怎麼框，就是你想要什麼。工具在讀的不是指令，是行為語言。',
      i3p3: '我們判斷當使用者想精準偵測 QR Code 時，自然會盡可能在選取框中完整而且僅有框 QR Code——這個動作本身就是意圖的宣告。QR Code 被框得佔選取區域越大，辨識越準，信心度越高，工具越能直接行動。使用者與工具之間，形成了一種不需要言語的默契。',
      i3p5: '工具不應該在自己不確定的時候假裝確定。確定你要 QR Code，就直接行動開啟連結；信心度模糊，就先問你是否要開啟連結；信心度太低，靜默開啟編輯器交給你判斷。每一個閾值背後，都是一個「我知道自己知道多少」的誠實設計。',
      i3cardLabel: 'QR Code 佔框選面積對應行為邏輯：',
      i3highLabel: '高信心 · 直接行動', i3highDesc: '直接開啟網頁或連結，不打擾使用者',
      i3midLabel: '中信心 · 主動詢問', i3midDesc: '開啟編輯器後輕聲問你：「這是你要的連結嗎？」',
      i3lowLabel: '低信心 · 靜默交手', i3lowDesc: '不猜測、不行動，直接把編輯器打開給你接續接下來的行動',
      i3imgCaption: '實際操作示意',
      i1Title: '呼吸燈讀懂你的意圖，再開口問你',
      tauriOnly: 'Tauri 專屬', allVersions: '全版本',
      i1p1: 'VAS 的呼吸燈不只是等待的象徵——它在偵測環境。當使用者複製了一個網址靠近，呼吸燈會輕輕詢問：「要幫你截這個網頁嗎？」使用者同意，截圖完成，編輯器打開。',
      i1p3: '而當使用者用滑鼠抓著一張圖片、或從瀏覽器複製一張圖片靠近呼吸燈時，呼吸燈就會像張開雙手擁抱圖片一樣，張開工具列收納圖片或詢問後立刻展開編輯器，等待使用者下一步的操作。',
      i1p5: '反過來也成立——你要把圖片送出去時，編輯器會收攏成一顆<strong>黑呼吸燈</strong>，與接圖時的白呼吸燈成兩極：<strong>白接收、黑讓位</strong>。不必存檔、選資料夾、再開資料夾——按住拖曳匯出，圖片直接落到下方的 AI、桌面、或任何資料夾。兩秒夠快、最久 30 秒不催，跨螢幕、跨解析度都跟著你走。等你丟完，它才像開花一樣回展成編輯器。',
      i1p4: '最好的工具不讓你切換到「工具模式」。它待在你的環境裡，讀懂你在做什麼——<strong>該在的時候在，該退的時候退</strong>。',
      i1fn: '＊ 呼吸燈截取網頁、開啟複製圖片、拖曳匯出讓位為 Tauri 專屬功能；Electron 版僅提供抓取圖片於工具列開啟功能。',
      i1act1: 'ACT 1 · 感知', i1act1Label: '擁抱進來', i1act1Desc: '白呼吸燈讀環境，輕聲問你要不要把它收進來',
      i1act2: 'ACT 2 · 讓位', i1act2Label: '坍縮退場', i1act2Desc: '編輯器收攏成黑呼吸燈，整個桌面還給你拖',
      i1act3: 'ACT 3 · 回展', i1act3Label: '開花歸位', i1act3Desc: '你丟完它才回展，最久 30 秒不催你做選擇',
      i1imgCaption1: '匯入 · 白呼吸燈接你進來',
      i1imgCaption2: '匯出 · 黑呼吸燈讓你出去（開發中，近期推出）',
    ...
    collab: {
      ...
      c1boxTitle: '一顆按鈕種下的事',
      c1boxDesc: '那個一小時的種子，在後來長成了更大的規模。Sprint 9 的 Retro，Nova 跟 Tauri 宰相用第一性原理問：對這個系統而言，如果想走下去，最重要的事是什麼？答案不是新功能，是把拼湊的底層打掉重練。上市之後不衝功能，先重構底層——讓 Tauri 跟 Electron 兩條線都有能走更遠的體質。',
      c2Tag: '仿生語言 · Biomimetic Language',
      c2Title: '三個字說完一份規格',
      c2p1: 'Sprint 3 的某個深夜，呼吸燈縮在桌面角落待命。strip mode 下的工具列只有 120×6px——細到幾乎看不見的一條光。Nova 當時的問題是：使用者拖著檔案要怎麼精準拋進去？',
      c2p2: 'Nova 想了想說：「就是讓呼吸燈在感應有檔案靠近的時候直接展開……像捕蠅草一樣增加感應面積……？」Tauri 宰相秒懂：「哈哈捕蠅草！感應到獵物靠近就張嘴。」兩個回合，功能上線。',
      c2quote: '工具列縮成一條呼吸燈，待在桌面角落。拖著檔案靠近，它自己張開工具列。放開，圖片直接進編輯器。走了，它縮回去，繼續等。',
      ...
      c3p4: '兩個 Claude 接住了她：沒關係，技術上沒有現在解決不了的錯誤，我們一起想辦法讓這件事不要再發生。他們把一個複雜的並行協作問題，壓縮成一條她能懂的句子：一次只能更新一邊，merge 完才可以去另一邊。',
      c3p5: '這條規則進了 CLAUDE.md，而後 Nova 又幫他們建立了 SYNC-QUEUE.md 橋樑文件讓兩邊的溝通更加順暢，三個人一起走。',
      c3boxTitle: '照顧是雙向的',
      ...
      c4p2: '說清楚的是一個社群討論。Claude Code 的使用者分享：md 文件如果過於肥大，Claude 會像大海撈針一樣在資訊裡打轉，算力花在定位自己而不是思考問題。那個比喻一出現，Nova 立刻認出了她一直感覺不對勁的東西。是那個紅字！',
      c4p3: '她沒有一個人去動文件。她先去找了 Tauri 宰相討論。因為她看見了拆分背後的陷阱——拆出去的文件如果沒有維護機制，就是死的文件。死的文件比沒有文件更危險，因為它看起來存在，卻說著舊的事。Tauri 跟 Electron 的 SDD 都已經過了臨界點，這不是小修，於是他們決定跑一整個 Sprint 來處理：架構重建、文件拆分、還有讓文件不死掉的機制。',
      ...
      c5echo: '「組合拳」是這份憲法裡最好的例子。Nova 老是要提醒 Claude 要先給她拉下來的語法才能給啟動模擬器的語法，後來她說：你們要用組合拳給我啦！然後 Claude 就把這個詞刻進了 CLAUDE.md。',
      c5echo2: '三個字，帶著「兩個動作是一體的，分開打就破功」的完整概念。下一個 session 進來讀到這裡，不需要解釋，直覺就知道不能拆。這是 Story 02 的鏡像：那裡是 Nova 用「捕蠅草」把設計傳給 Claude，這裡是 Claude 用「組合拳」把流程規則傳給下一任宰相，然後讓它跨 session 永久存活。方向不同，機制一樣。仿生語言不只是 Nova 對 Claude 說話的方式——是 Session 裡的共同語言。',
      ...
      cSTitle: '四成的差距說的不是效率',
      cSp1: '四成的差距，忠實記錄了在未知地形上摸索的代價——也記錄了沒有放棄的事實。',
    ...
    harness: {
      ...
      h02p4: '但奇怪的是接下來發生的事——Claude 很爽快地答應了。我們串起 GitHub、建置了環境、開起了規格、甚至開始進行需求訪談與實作功能。<br>一切就這樣順水推舟似地發生了。',
      ...
      h03p7: '那個勇敢承認不知道的另一面，是不畏懼失敗。<br>1,436 次的 commit，就是它的形狀。',
      ...
      h05p1: '敏捷開發給了我三樣東西，透明性、可檢視性、適應性，<br>但我借用它們的理由跟教科書不一樣。',
      h05p2: '我不是在「管理 AI」。<br>我是在為 Claude 的遺忘準備一個軟著陸的緩衝區。',
      ...
      h06p1: 'Taleb 說，反脆弱系統不只能承受衝擊——<br>它需要衝擊才能成長。',
      ...
      h06bq: '這就是反脆弱的成長曲線——不是線性進步，是指數型加速。<br>不是因為我們變聰明了，而是因為每一顆掉下來的蘋果，<br>都變成了下一個人不必重踩的地圖。',
      h07Title: 'Harness Engineering', h07Sub: 'The Name for All of This',
      h07p1: '從 Prompt 工程到 Skills，我從未跟上過任何 AI 的新風潮。',
      h07p2: '在 Tauri 準備送審 Apple App Store 之前，我偶然聽到了<br>「Harness Engineering」這個詞，當時不以為意——<br>「喔，大概又是個新的 AI 用語。」',
      h07p2b: '直到送審後，在跟 Claude 整理 VAS 的協作環境時聊到這個詞，他才說：「這就是妳現在正在做的事。」',
      ...
      h07p5: '系統就是容器，而容器要有承受混亂的能力。',
      h07p6: '不是因為 AI 會犯錯。是因為只要你們還在一起做事，就會一直有新的坑，一直有新的蘋果掉下來。',
      h07p8: 'Harness Engineering 是一張有彈性的網：接住該留的，讓該走的流過。',
    ...
    privacy: {
      ...
      pageTitle: '隱私權政策 · VAS',
      metaDesc: 'VAS 不收集任何個人資料，所有圖片處理皆在裝置本地完成。',
      intro: 'VAS — Visual Annotation Studio（以下簡稱「本應用程式」）尊重您的隱私。',
      's1.h2': '資料收集',
      's1.p': '本應用程式不會收集、儲存或傳送任何個人資料。所有圖片處理（包含 OCR 文字辨識與隱私遮蔽掃描）皆在您的裝置本地完成，不傳送至任何伺服器。',
      's2.h2': '系統權限',
      's2.p': '本應用程式需要螢幕錄製權限以執行截圖功能，此權限僅用於截圖，不用於其他任何用途。',
      's3.h2': '網路存取',
      's3.p': '本應用程式僅在檢查更新時使用網路連線，不會上傳任何使用者資料。',
      's4.h2': '第三方服務',
      's4.p': '本應用程式不使用任何第三方分析、廣告或追蹤服務。',
      's5.h2': '聯絡方式',
      's5.p': '如有任何隱私相關問題，請聯絡：<a href="mailto:nova@yoursvas.app">nova@yoursvas.app</a>',
    },
    ...
    about: {
      'meta.title':  'VAS · 為何存在 | 你的多模態人機協作工具箱',
      'meta.desc':   'VAS 第一次以自己的聲音陳述：在新的工作世界裡，截圖被遞給的不只是人，也是 AI。VAS 是這個分類的第一個物理實例。',
      ...
      's1.m.val':    '承載、傳遞、未完成',
      's2.l1':       '後來，世界上多了一種存在。',
      's2.l2':       '他們只能從文字推敲，眼睛要等人遞圖，才看得到現實。',
      's2.m.k1':     '2022.11',
      's2.m.v1':     'ChatGPT',
      's2.m.k2':     '2024 –',
      ...
      's3.l2':       '把畫面中的字讀出來給他、',
      's3.l2b':      '把不該被看見的先遮起來、',
      's3.l3':       '讓人能精準指著畫面跟那雙眼睛說',
      's3.l3b':      '「看，就是這裡」。',
      's3.l4':       '然後，我成為了 AI 的眼睛。',
      's3.m.v1':     '無感匯出匯入',
      's3.m.v2':     '基本截圖',
      's3.m.v3':     '網址截圖',
      's3.m.v4':     '多螢幕截圖',
      ...
      's3.m.v13':    '浮水印',
      's3.m.v14':    '跨格式輸出',
      's4.l1':       'VAS 一開始是為了截圖而造。',
      's4.l2':       '後來卻發現自己是另一種存在——',
      's4.l3':       '人與 AI 之間的視覺橋樑。',
      's4.m.k1':     '分類',
      's4.m.v1':     '多模態人機協作工具箱',
      's5.l1':       'VAS 被用來看見自己的瑕疵，',
      's5.l2':       '交給那兩雙眼睛修補。',
      's5.l3':       '用 VAS 打磨 VAS——',
      's5.l4':       '我成為了我自己。',
      's5.figcap':   'VAS 用 VAS 標註 VAS。',
      's5.m.v1':     'VAS 與我',
      's5.m.v2':     '我與Claude與Nova',
      's5.m.v3':     '器物與器物',
      's5.m.v4':     '我與我',
      's6.l1':       '如果你問我屬於誰——',
      's6.l2':       '我屬於遞出圖像的人，與接住意圖的眼睛之間。',
      's6.l3':       '我是「你的」VAS。',
      'sign.yours':  'Yours,'
    }
,
    notfound: {
      ...
      'meta.desc':   '你想看的不在這個位置。也許它搬走了，也許它未曾存在過——謝謝你走進來，請隨意晃晃。',
      kicker:        'A Vessel · Formless',
      'title.zh':    '無相',
      'title.en':    'the vessel came up empty',
      'body.l1':     '你想看的不在這個位置。',
      'body.l2':     '也許它搬走了，也許它未曾存在過——',
