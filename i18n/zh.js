...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    milestone: {
      ...
      r2bitems: '<li>✓ 測試基建補強　— 多螢幕函式重構 / 命名回歸測試 × 4 / cargo test 30 pass</li><li>✓ i18n 架構重整　— per-language 子檔拆分 / Vitest 179 tests / 簡中 Pro-only</li><li>✓ 隱私掃描多語特化　— PRC 個資格式 × 13 / Vision OCR 語言模型修正</li><li>✓ 文件歸檔系統　— KM 89 條重新編目 / SDD・TDD 歷史歸檔</li>',
