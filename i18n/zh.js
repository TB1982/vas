...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    faq: {
      ...
      'q4.a':         '<p>從免費版（Electron）升級到付費版（Tauri）後，因為 macOS 把兩者視為不同的 App，舊權限不會自動繼承。請依下列步驟重新授權：</p><ol><li>先關掉所有 VAS（<em>包含 Electron 版與 Tauri 版</em>），並移除免費版。</li><li>開啟「<strong>系統設定 → 隱私權與安全性 → 螢幕與系統錄音</strong>」。</li><li>找到 VAS，按下方的「<strong>−</strong>」移除舊權限。</li><li>重新打開付費版 VAS，按「<strong>全螢幕截圖</strong>」觸發系統授權。</li><li>系統會把 VAS 重新加回清單，預設<em>關閉狀態</em>。</li><li>手動把開關打開，依提示<strong>結束 VAS 再重啟一次</strong>，即可獲得完整權限。</li></ol>',
      'q5.q':         'VAS 提供網頁截圖嗎？',
      'q5.a':         '<p>VAS Pro（Tauri · App Store · 9.99 美元）支援網頁截圖。複製網址後拖到呼吸燈或工具列，VAS 會跳出提示詢問是否要截網頁；確認後，VAS 在背景開啟瀏覽器完成整頁截圖，直接送進編輯器等你下一步處理。</p><p>但若你想截的是<em>需要登入才看得到的頁面</em>，目前推薦使用瀏覽器原生外掛（如 FireShot）截下來後，再拋進 VAS 後製處理。</p>',
      ...
      'q7.q':         'VAS 可以自訂截圖快捷鍵嗎？',
      'q7.a':         '<p><strong>VAS Pro</strong>（Tauri · App Store · 9.99 美元）提供<em>四組</em>自訂快捷鍵——全螢幕截圖、視窗截圖、矩形截圖、剪貼簿貼入——給從其他截圖軟體移民的你最熟悉的手感。</p><p><strong>Electron 免費版</strong>內建固定三組（⌘^1 / ⌘^2 / ⌘^X），不可變更。</p>',
