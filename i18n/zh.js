...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    milestone: {
      ...
      r2h: 'v2.0　架構重構（Sprint 10–24+）', r2p: '進行中（04/11 啟動 · Sprint 24 完成 · 約 5 Sprint 待跑）',
      r2items: '<li>✓ 座標系統統一（DPR 全修）</li><li>✓ 漸層引擎統一（六工具）</li><li>✓ 資料模型正規化</li><li>✓ 屬性面板框架化（TOOL_SCHEMA 10/10 覆蓋）</li><li>✓ 幾何 + 渲染管線模組化</li><li>✓ Undo/Redo 架構升級 + 記憶體衛生</li><li>✓ 自動化測試基建（Vitest 47 pass）</li><li>· 重構範圍擴展中⋯</li>',
      r3h: 'v3.0　功能爆發',
