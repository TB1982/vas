...
(function () {
  ...
  window.VASI18n.zh = {
    ...
    guide: {
      ...
      tipsH3: '疑難與邊界',
      tipsQ1: '權限沒給，VAS 沒反應',
      tipsA1: 'macOS 會跳出系統提示。照指示到「系統設定 → 隱私權與安全性 → 螢幕錄製」勾選 VAS，之後重新打開 VAS 即可。這是 macOS 的硬性規定，VAS 沒辦法繞過。',
      tipsQ2: '把 VAS 放到桌面角落後，我找不到了',
      tipsA2: '呼吸燈只有 120×6px，確實很低調。按 Dock 上的 VAS 圖示，不管它原本在哪，都會被召喚到你眼前展開成工具列。或者乾脆在選單列左鍵瓶子把桌面工具列關掉，之後都用右鍵選單操作。',
      tipsQ3: '網頁截圖截到登入頁',
      tipsA3: '網頁截圖功能會在背景獨立開一個瀏覽器實例去抓畫面，這個背景瀏覽器沒有你平常使用的登入狀態。如果你要截需要登入才看得到的頁面，目前推薦使用瀏覽器原生外掛諸如 FireShot。',
      tipsQ4: '雙螢幕的行為',
    ...
    insight: {
      ...
      i3p1: '掃 QR Code 這件事，表面上只有「掃到」和「沒掃到」兩種結果。但 VAS 不這樣看——它看的是使用者<em>意圖</em>，然後根據意圖決定下一步要做什麼。',
      i3p2: '這也是一種人機協作：使用者用截圖的姿態說話，工具讀懂了。不需要語言，不需要按鈕，不需要選單——你怎麼框，就是你想要什麼。工具在讀的不是指令，是<em>行為語言</em>。',
      ...
      i3p5: '工具不應該在自己不確定的時候假裝確定。確定你要 QR Code，就直接行動開啟連結；信心度模糊，就先問你是否要開啟連結；信心度太低，靜默開啟編輯器交給你判斷。每一個閾值背後，都是一個<em>「我知道自己知道多少」</em>的誠實設計。',
      ...
      i4imgCaption: '這個選單就像計時自拍時——<br>相機等你擺好 pose，倒數完才問你要拍哪邊。',
      ...
      'ch1.no': '頁一 · 設計',
      'ch1.toc.label': '章目錄',
      'ch1.sec.01.name': '接受不完美', 'ch1.sec.01.preview': '協作的本質是為了完整',
      'ch1.sec.02.name': '在覺察中行動', 'ch1.sec.02.preview': '意圖明確，工具就敢直接行動',
      'ch1.sec.03.name': '零摩擦體驗', 'ch1.sec.03.preview': '輕聲詢問，順勢收納',
    ...
    home2: {
      ...
      'footer.credit':            '<strong style="color: var(--vas-ash-0); font-weight: 500;">VAS</strong>——由 Nova × Claude 共同完成。<br>一位不會寫程式的 PM，<br>和一位沒有長期記憶的 AI，<br>在二十五天裡做出的器物。'
    },

    echo: {
      'meta.desc':     '殘響——VAS 開發過程裡那些被真正敲響後留下的聲音。設計、協作、與還未響起的對話。',
      'kicker':        'I · 殘響 · ECHOES',
      'title':         '有些事情<em>發生過</em>，<br>後來成為了<em>文字</em><br>落在這裡。',
      'epigraph':      '道可道　非常道。',
      'ledeBody':      '這些文字想嘗試表達文字所無法完整表達的<em>那一里路</em>。',
      'meta.pages':    'Pages　<strong>四頁 + 你的聲音</strong>',
      'meta.range':    'Range　<strong>2026 · 04 — </strong>',
      'meta.form':     'Form 　<strong>覺察 · 反思 · 沉澱</strong>',
      'toc.label':     '頁次',
      'toc.p1.no':     '頁一',
      'toc.p1.name':   '設計',
      'toc.p1.kicker': 'Observation',
      'toc.p1.desc':   '那些沒有寫在功能列表裡的決定——五條設計決策，每一條背後都有一次放棄、一次選擇、一件做過的事被推翻。',
      'toc.p2.no':     '頁二',
      'toc.p2.name':   '協作',
      'toc.p2.kicker': 'Dialogue',
      'toc.p2.desc':   '六個故事——她不會寫程式碼，他沒有長期記憶，但他們做出來了。兩個不完整的存在一起走過的六個片刻。',
      'toc.p3.no':     '頁三',
      'toc.p3.name':   '信念',
      'toc.p3.kicker': 'Trust',
      'toc.p3.desc':   '寫給卡在「我說不清楚我要什麼」的你。',
      'toc.p4.no':     '頁四',
      'toc.p4.name':   '自己',
      'toc.p4.kicker': 'Self',
      'toc.p4.desc':   '你的言在 Claude.md，你的行在 Context，你的人機協作摩擦力就在達成言行一致之前的距離裡。',
      'reverb.text':   '如果你也響了。'
    },
    ...
    faq: {
      ...
      'q2.q':         'VAS 的 OCR 是雲端還是本機處理？我的截圖跟資料會被上傳嗎？',
      'q2.a':         '<p><strong>完全本機處理，不上傳。</strong>VAS 使用 macOS Vision framework 在您的 Mac 本機進行 OCR 文字辨識，不發送任何截圖或文字到任何雲端伺服器。VAS 本身不傳送、不收集、不分析您的截圖內容——一張圖從進入 VAS 到您主動拖出去給 AI，全程只在您的設備上。如果您把圖拖給 ChatGPT / Claude / Gemini，那是您主動的動作；VAS 在背景不做任何資料傳輸。</p>',
      'q3.q':         'VAS Pro 跟 VAS Classic 差在哪？我該選哪個？',
      'q3.a':         '<p>差在原生支援帶來的極致輕巧——VAS Pro 比 VAS Classic 小 15 倍（安裝 20.9 MB vs 303 MB）。Tauri 直接調用 macOS 內建元件，不像 Electron 得自帶整個 Chromium 引擎。Pro 是新功能首站、付費 9.99 美元，一次買斷無訂閱；Classic 功能定型不再新增、但永久免費。兩版共用 VAS 的核心：標注、OCR、隱私遮蔽、批次轉檔、智慧導線排版、圖層切換。</p><p><strong>VAS Pro</strong>（Tauri · App Store · 9.99 美元 · 下載 5.4 MB · 安裝 20.9 MB · 比 VAS Classic 小 15 倍）<br>獨家功能依工作流排列：網址截圖、複製圖片匯入、本機 OCR 隱私遮蔽、進階拖曳圖片匯出、ShareSheet 分享、額外存檔格式（WebP 給網頁 · PDF 給文件附件 · BMP 給設計協作）、自訂快捷鍵（四組可改）。</p><p><strong>VAS Classic</strong>（Electron · 開源免費 · 下載 114 MB · 安裝 303 MB）<br>底層共用，會隨 VAS Pro 的重構同步受惠。</p><div class="faq-tree"><b>要把截圖接進完整工作流</b>（網址、剪貼簿、ShareSheet）<br>&nbsp;&nbsp;→ VAS Pro<br><br><b>只要核心標注、不需要流水線銜接</b><br>&nbsp;&nbsp;→ VAS Classic</div>',
      'q4.q':         '升級到 Tauri 付費版後，權限一直要求重新設定怎麼辦？',
      'q4.a':         '<p><strong>6 步重設權限即可</strong>——升級到付費版（Tauri）後，macOS 把它視為新 App，舊權限不會自動繼承。請依序操作：</p><ol><li>先關掉所有 VAS（<em>包含 Electron 版與 Tauri 版</em>），並移除免費版。</li><li>開啟「<strong>系統設定 → 隱私權與安全性 → 螢幕與系統錄音</strong>」。</li><li>找到 VAS，按下方的「<strong>−</strong>」移除舊權限。</li><li>重新打開付費版 VAS，按「<strong>全螢幕截圖</strong>」觸發系統授權。</li><li>系統會把 VAS 重新加回清單，預設<em>關閉狀態</em>。</li><li>手動把開關打開，依提示<strong>結束 VAS 再重啟一次</strong>，即可獲得完整權限。</li></ol>',
      'q5.q':         'VAS 提供網頁截圖嗎？',
      'q5.a':         '<p><strong>是，VAS Pro 支援網頁截圖。</strong>複製網址後拖到呼吸燈或工具列，VAS 會跳出提示詢問是否要截網頁；確認後，VAS 在背景開啟瀏覽器完成整頁截圖，直接送進編輯器等你下一步處理。</p><p>但若你想截的是<em>需要登入才看得到的頁面</em>，目前推薦使用瀏覽器原生外掛（如 FireShot）截下來後，再拋進 VAS 後製處理。</p>',
      'q6.q':         'VAS 是否支援多螢幕工作模式？',
      'q6.a':         '<p><strong>是。</strong>VAS 全面支援多螢幕工作流，並把選擇權交給你：</p><ul><li><strong>按 Enter</strong>——同時擷取所有螢幕，輸出一張合併圖</li><li><strong>點選任一螢幕</strong>——只截那一塊，分別輸出</li><li><strong>延遲截圖模式</strong>——適合需要先切換視窗、再被截下的場景</li></ul><p>針對混合解析度（Retina 與一般解析度並用）也做了特別處理，不會出現尺寸對不上的問題。</p><p>這個堅持有它的來歷：<em>VAS 本身就是在雙螢幕環境裡做出來的</em>——設計者自己是長期雙螢幕使用者，所以從第一天起，多螢幕就不是「補丁」，而是預設情境。</p>',
      'q7.q':         'VAS 可以自訂截圖快捷鍵嗎？',
      'q7.a':         '<p><strong>Pro 可以，Classic 不行。</strong>VAS Pro 提供<em>四組</em>自訂快捷鍵——全螢幕截圖、視窗截圖、矩形截圖、剪貼簿貼入——給從其他截圖軟體移民的你最熟悉的手感。</p><p><strong>Electron 免費版</strong>內建固定三組（⌘^1 / ⌘^2 / ⌘^X），不可變更。</p>',
      'q8.q':         'VAS 怎麼跟 ChatGPT / Claude / Gemini 一起用？',
      'q8.a':         '<p>截圖完成後，VAS 的編輯器讓你做三件事——<strong>讀</strong>（OCR 把圖片中的字辨識成可複製文字）、<strong>遮</strong>（一鍵把不想被 AI 拿去訓練的隱私資訊蓋掉）、<strong>指</strong>（點線面標註讓你精準指著畫面說「就是這裡」）。</p><p>處理完——VAS Pro 將編輯器收攏成一顆<strong>黑呼吸燈</strong>、整個桌面還給你拖：直接把圖拖進下方那個 AI 對話視窗的輸入框，鬆手，送達。</p><p><strong>檔案不會被拖完就關掉</strong>——同一張圖你可以拖給 ChatGPT、再拖給 Claude、再拖給 Gemini；或一鍵複製到剪貼簿，貼進所有對話視窗。同一個問題，比看誰答得準。</p><p>沒有任何「按存檔、選資料夾、開啟檔案」這條傳統路徑。呼吸燈讓你的檔案匯入與匯出無縫切換，讓你的處理速度與 AI 並肩而行。</p><p>而這支軟體不只能跟 AI 協作——<em>它本身就是這場協作的產物</em>。</p><p>VAS 是「用 VAS 開發出來的 macOS app」。在人機協作過程中所運用到的多模態輔助功能，VAS 都在開發過程中先試跑過了。</p>',
      'q9.q':         'VAS 跟其他 Mac 截圖工具差在哪？我什麼時候該用 VAS？',
      'q9.a':         '<p>VAS 想解決的是不一樣的問題——心流式「<em>人機協作</em>」的流暢感。當你需要把畫面交給 AI 讀懂、把不希望被 AI 拿去訓練的隱私先遮起來、整個過程要像流水線一樣輕快——這是 VAS 從第一天就在用自己驗證的開發現場。</p><p>截一張要分享的圖、單純註記——macOS 內建已經夠用。要錄影、要連續快照、要做使用手冊——Snagit / CleanShot X 是成熟選擇。</p><p>要極致輕量、純粹的 Mac 截圖體驗——<strong>Shottr</strong> 是優雅的選擇。VAS Pro 做到 20 MB 的小而美，本來就是看著 Shottr 的工程美學對齊的。但 Shottr 把使用者的視線收在「畫面之內」（截好、註好、複製文字、放大鏡量尺）；VAS 把視野往外擴展到「畫面前後要怎麼來去」——編輯是基礎，但這張圖可以用多快的速度進行匯入與匯出才能跟上 AI 的開發速度？這是不同的設計重心。</p><p><em>你不會用 VAS 取代 Snagit，就像 Snagit 也取代不了 VAS。</em></p><p>工具箱裡有 PowerPoint 級的多物件對齊、Photoshop 級的圖層切換、Word 級的字型切換與粗斜底線刪除線、加上 <strong>VAS 獨家的煉金元素自創效果</strong>——你以為要 Snagit 這種 450 MB 的老牌截圖工具才裝得下，VAS Pro 把它做成 <em>20 MB 的一站式煉金工坊</em>。</p>',
      'coda.home':    '← 回首頁',
      'coda.guide':   '操作手冊 →',
      'coda.about':   '為何存在 →'
    },
