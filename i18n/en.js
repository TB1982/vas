(function () {
  ...
  window.VASI18n.en = {
    ...
    guide: {
      ...
      ocrP2: 'For supported language markets, OCR applies <strong>localized privacy masking</strong><span class="g-badge-t" style="margin:0 4px 0 6px">Tauri only</span>—',
