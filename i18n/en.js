(function () {
  ...
  window.VASI18n.en = {
    ...
    faq: {
      ...
      'q7.a':         '<p><strong>VAS Pro</strong> (Tauri · App Store · $9.99) offers <em>four</em> custom shortcuts — full-screen capture, window capture, rectangular capture, paste from clipboard — giving you the most familiar feel if you\'re migrating from another screenshot tool.</p><p>The <strong>Electron free edition</strong> ships with three fixed bindings (⌘^1 / ⌘^2 / ⌘^X), not reassignable.</p>',
