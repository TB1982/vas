(function () {
  ...
  window.VASI18n.en = {
    ...
    milestone: {
      ...
      s16desc: 'TOOL_GEOMETRY schema (bounds / getHandles / moveAnnot single-line dispatch) · Figma-style click-to-select (click any object in any tool mode auto-switches) · Vitest 211 pass',
      s17num: 'S17',
      ...
      r2items: '<li>Coordinate system unified (DPR fully fixed)</li><li>Gradient engine unified (6 tools)</li><li>Data model normalisation</li><li>Properties panel framework (TOOL_SCHEMA 10/10 coverage)</li><li>Geometry + rendering pipeline modularisation</li><li>Undo/Redo architecture upgrade + memory hygiene</li><li>Automated test infrastructure (Vitest 211 pass)</li>',
