(function () {
  ...
  window.VASI18n.en = {
    ...
    shared: {
      footer: 'Deployed via Cloudflare　｜　Built with Claude Code　｜　Last updated 2026 by <a href="mailto:nova@yoursvas.app" class="hover:text-white/50 transition-colors">Nova</a>',
    ...
    insight: {
      ...
      i1Tag: 'Frictionless by Design',
      i2Tag: 'Human-AI Collaboration',
      i3Tag: 'Behaviour as Meaning',
      i4Tag: 'Eliminating Interruption',
      i5Tag: 'Design Token Architecture',
      i1Title: 'The breathing light reads your intent — then asks',
      i1p1: 'VAS\'s breathing light isn\'t just a symbol of waiting — it\'s sensing the environment. When a user copies a URL nearby, the light gently asks: "Want me to capture this webpage?" User confirms, screenshot taken, editor opens.',
      i1p3: 'And when a user drags an image or copies one from a browser toward the breathing light, the light opens up like welcoming arms — expanding the toolbar to receive the image or, after a quick confirmation, immediately launching the editor for whatever comes next.',
      i1p5: 'The reverse holds too — when you want to send an image out, the editor folds itself into a single <strong>black breathing light</strong>, twin to the white one that received it: <strong>white to receive, black to step aside</strong>. No saving, no folder picking, no folder reopening — press, drag, and the image lands directly into the AI below, the desktop, or any folder you like. Two seconds is plenty; thirty seconds at most before any nudge — across screens, across resolutions, it follows you. Only after you let go does it bloom back into the editor.',
      i1p4: 'The best tools don\'t make you switch into "tool mode." They live in your environment, read what you\'re doing — <strong>present when needed, gone when not</strong>.',
      i1fn: '＊ Breathing-light webpage capture, copied-image opening, and drag-to-export step-aside are Tauri-exclusive features. The Electron version offers only image pickup via the toolbar.',
      i1act1: 'ACT 1 · Sense', i1act1Label: 'Embrace In', i1act1Desc: 'The white breathing light reads the room and quietly asks if you want to bring it in',
      i1act2: 'ACT 2 · Step Aside', i1act2Label: 'Fold Away', i1act2Desc: 'The editor collapses into a black breathing light — the whole desktop is yours to drag across',
      i1act3: 'ACT 3 · Return', i1act3Label: 'Bloom Back', i1act3Desc: 'Only after you let go does it bloom back — up to thirty seconds, never rushing your choice',
      i1imgCaption1: 'Import · the white light receives you',
      i1imgCaption2: 'Export · the black light steps aside for you (in development, coming soon)',
      i2Title: 'No perfect human-AI pair — but a complete collaboration',
      i2p1: 'VAS automatically detects sensitive text on screen and marks areas to be hidden. But during development we found OCR still has inherent limits — occasionally missing or misreading content. We simply chose not to keep pushing for a perfect tool.',
      i2p2: 'I wanted recognition errors to be more than just a tool failure — to become a handoff point for collaboration.',
      i2p3: 'We made the privacy mosaic a floating layer with adjustable size: wherever OCR falls short, the user steps in manually.',
      i2p4: 'A recognition error stops being a "mistake" — it becomes a division of labour. The tool\'s imperfection leaves the user\'s control intact.',
      i2p5: 'OCR may only automate 90% of the task — but a quick drag of the manual mosaic handles what would otherwise be 100% manual work.',
      i2p6: 'And if you cover the wrong area, no problem — mosaics are independent floating objects, deleted with a single undo. Nothing is irreversible.',
      i2box1Label: 'OCR Auto', i2box1Desc: 'Recognise as much as possible, auto-mark sensitive areas',
      i2box2Label: 'Mosaic Fill-in', i2box2Desc: 'Where OCR falls short, the user takes over manually',
      i2box3Desc: 'Covered the wrong spot? One-tap delete — no irreversible decisions',
      i3Title: 'QR Code detected — but how confident is it?',
      i3p1: 'Scanning a QR code seems like a binary outcome — found or not found. But VAS sees it differently: it reads user intent, then decides what to do next based on that intent.',
      i3p2: 'This is also human-AI collaboration: the user speaks through how they frame the screenshot, and the tool understands. No language, no buttons, no menus — how you frame it is what you want. The tool isn\'t reading commands; it\'s reading behaviour.',
      ...
      i3p5: 'A tool shouldn\'t pretend to be certain when it isn\'t. When intent is clear, it opens the link directly; when confidence is ambiguous, it asks if you\'d like to open it; when confidence is too low, it silently opens the editor and hands over to you. Behind each threshold is an honest design: knowing how much it knows.',
      i3cardLabel: 'QR Code area within selection — behaviour logic:',
      i3highLabel: 'High confidence · Act directly', i3highDesc: 'Opens the page or link immediately, no interruption',
      i3midLabel: 'Mid confidence · Ask first', i3midDesc: 'Opens the editor and gently asks: "Is this the link you wanted?"',
      i3lowLabel: 'Low confidence · Silent handoff', i3lowDesc: 'No guessing, no action — opens the editor for you to take it from there',
      i3imgCaption: 'How it looks in practice',
      ...
      i4step1Label: 'Delayed capture', i4step1Desc: 'Single-monitor delay mode: automatically captures the current screen after the countdown',
      i4step2Label: 'Custom overlay', i4step2Desc: 'Dual-monitor, no delay: freely choose a screen, or press Enter to capture all screens at once',
      i4step3Label: 'Mouse-position default', i4step3Desc: 'Dual-monitor delay mode: no selection needed — the tool reads your cursor position and captures there automatically',
    ...
    echo: {
      ...
      'ledeBody':      'These words try to reach what words alone cannot — <em>that final mile</em>.',
      'meta.pages':    'Pages　<strong>Four pages + your voice</strong>',
      'meta.range':    'Range　<strong>2026 · 04 — </strong>',
      'meta.form':     'Form 　<strong>Awareness · Reflection · Settling</strong>',
      'toc.label':     'Contents',
      'toc.p1.no':     'I',
      'toc.p1.name':   'Design',
      'toc.p1.kicker': 'Observation',
      'toc.p1.desc':   'The decisions that never made the feature list — five design choices, each one with a discarded version, a chosen path, and something done then undone.',
      'toc.p2.no':     'II',
      'toc.p2.name':   'Collaboration',
      'toc.p2.kicker': 'Dialogue',
    ...
    faq: {
      ...
      'title.h1':     'About VAS, in <em>nine questions</em>.',
      ...
      'q2.q':         'Does VAS use cloud OCR or on-device? Are screenshots or text uploaded?',
      'q2.a':         '<p><strong>Fully on-device, nothing uploaded.</strong> VAS uses macOS Vision framework for OCR locally on your Mac, never sending screenshots or text to any cloud server. VAS itself does not transmit, collect, or analyze your screenshot contents — from the moment an image enters VAS until you actively drag it out to AI, everything stays on your device. If you drag an image to ChatGPT / Claude / Gemini, that\'s your active action; VAS performs no background data transfer.</p>',
      'q3.q':         'What\'s the difference between VAS Pro and VAS Classic? Which one should I pick?',
      'q3.a':         '<p>The difference is Tauri\'s native architecture and the radical lightness it brings: VAS Pro is <strong>15× smaller</strong> than VAS Classic (20.9 MB vs 303 MB installed). Tauri calls macOS native components directly; Electron has to ship its own Chromium engine. Pro is the launchpad for new features — paid · $9.99 one-time, no subscription; Classic is feature-frozen but permanently free. Both share VAS\'s core: annotation, OCR, privacy masking, batch conversion, smart alignment guides, layer switching.</p><p><strong>VAS Pro</strong> (Tauri · App Store · $9.99 · 5.4 MB download · 20.9 MB installed · 15× smaller than VAS Classic)<br>Exclusive features in workflow order: URL capture, copied-image import, on-device OCR privacy masking, advanced drag-to-export, ShareSheet, extra save formats (WebP for web · PDF for attachments · BMP for design handoff), customizable shortcuts (4 slots).</p><p><strong>VAS Classic</strong> (Electron · open-source · 114 MB download · 303 MB installed)<br>Shares the same foundation as Pro — benefits from every refactor on the Pro side.</p><div class="faq-tree"><b>To wire screenshots into a full workflow</b> (URLs, clipboard, ShareSheet)<br>&nbsp;&nbsp;→ VAS Pro<br><br><b>Just want the core annotation, no pipeline</b><br>&nbsp;&nbsp;→ VAS Classic</div>',
      'q4.q':         'After upgrading to the paid Tauri edition, permissions keep asking to be reset. What do I do?',
      'q4.a':         '<p><strong>Re-authorize in 6 steps.</strong> When you upgrade from free (Electron) to paid (Tauri), macOS treats them as different apps, so existing permissions don\'t carry over. Follow these steps:</p><ol><li>Quit every VAS (<em>both the Electron and Tauri versions</em>) and remove the free version.</li><li>Open <strong>System Settings → Privacy & Security → Screen & System Audio Recording</strong>.</li><li>Find VAS and click the <strong>−</strong> below to remove the old permission.</li><li>Reopen the paid VAS and hit <strong>Full-Screen Capture</strong> to trigger the system authorization prompt.</li><li>The system adds VAS back to the list, defaulted to <em>off</em>.</li><li>Flip the switch on manually, follow the prompt to <strong>quit VAS and restart it once more</strong>, and full permissions are yours.</li></ol>',
      'q5.q':         'Does VAS do web screenshots?',
      'q5.a':         '<p><strong>Yes, VAS Pro supports web page capture.</strong> Copy a URL and drag it to the breathing light or toolbar; VAS will pop a prompt asking whether to capture the web page; once confirmed, VAS opens a browser in the background and completes a full-page screenshot, sending it straight to the editor for your next move.</p><p>But if the page you want <em>requires a login to view</em>, the current recommendation is to use a native browser extension (like FireShot) to grab it, then toss it into VAS for post-processing.</p>',
      'q6.q':         'Does VAS support multi-display setups?',
      'q6.a':         '<p><strong>Yes.</strong> VAS supports multi-display workflows end to end, and hands you the choice:</p><ul><li><strong>Press Enter</strong> — capture every display at once, output as one merged image</li><li><strong>Click a single display</strong> — capture only that one, output separately</li><li><strong>Delayed capture mode</strong> — for when you need to switch windows first, then be captured</li></ul><p>Mixed resolutions (Retina alongside standard) are handled specially, so you won\'t hit size mismatches.</p><p>This commitment has its backstory: <em>VAS itself was built in a dual-display environment</em> — its designer is a long-time dual-display user, so from day one, multi-display wasn\'t a "patch" but the default scenario.</p>',
      'q7.q':         'Can I customize VAS\'s screenshot shortcuts?',
      'q7.a':         '<p><strong>Pro yes, Classic no.</strong> VAS Pro offers <em>four</em> customizable shortcuts — fullscreen capture, window capture, rectangle capture, clipboard paste — to give migrants from other screenshot tools the same muscle memory.</p><p>The <strong>Electron free edition</strong> ships with three fixed bindings (⌘^1 / ⌘^2 / ⌘^X), not reassignable.</p>',
      'q8.q':         'How do I use VAS with ChatGPT / Claude / Gemini?',
      'q8.a':         '<p>Once the capture is done, VAS\'s editor lets you do three things — <strong>read</strong> (OCR turns the text inside the image into copyable text), <strong>mask</strong> (one click to cover up anything private you don\'t want AI training on), and <strong>point</strong> (point/line/area annotation lets you precisely point at the screen and say "right here").</p><p>When you\'re done — VAS Pro folds the editor back into a single <strong>black breathing light</strong>, hands the desktop back for dragging: drag the image straight into that AI chat window\'s input box below, let go, delivered.</p><p><strong>The file doesn\'t close after the drag</strong> — the same image can be dragged to ChatGPT, then Claude, then Gemini; or copied to the clipboard with one click and pasted into every chat window. Same question, see who answers best.</p><p>None of the traditional "hit save, pick a folder, open the file" routine. The breathing light makes your file import and export switch without a seam, so your processing speed walks shoulder-to-shoulder with AI.</p><p>And this app doesn\'t just collaborate with AI — <em>it is itself the product of that collaboration</em>.</p><p>VAS is "a macOS app built using VAS." Every multimodal assist function used in the human-AI collaboration was test-driven through VAS\'s own development first.</p>',
      'q9.q':         'How is VAS different from other Mac screenshot tools? When should I reach for VAS?',
      'q9.a':         '<p>VAS is trying to solve a different problem — the flow-state smoothness of <em>human-AI collaboration</em>. When you need to hand a screen to AI to read, mask the private bits you don\'t want AI training on, and have the whole thing run like a clean pipeline — this is the development floor VAS has been using to verify itself from day one.</p><p>One screenshot to share, simple markup — macOS built-ins are plenty. Video recording, burst captures, building user manuals — Snagit / CleanShot X are mature picks.</p><p>For maximum lightness, the pure Mac screenshot experience — <strong>Shottr</strong> is the elegant pick. VAS Pro\'s 20 MB small-and-beautiful was aligned against Shottr\'s engineering aesthetic from the start. But Shottr keeps the user\'s gaze "inside the frame" (capture, annotate, copy text, magnifier ruler); VAS pushes the field of view outward to "how the image gets in and out before and after the frame" — editing is the baseline, but how fast can this image be imported and exported to keep up with AI development speed? Different centers of design gravity.</p><p><em>You won\'t use VAS to replace Snagit, just as Snagit can\'t replace VAS.</em></p><p>The toolbox holds PowerPoint-grade multi-object alignment, Photoshop-grade layer switching, Word-grade font switching with bold/italic/underline/strikethrough, plus <strong>VAS\'s exclusive alchemy-element custom effects</strong> — what you\'d assume needs a 450 MB heritage screenshot tool like Snagit to hold, VAS Pro packs into a <em>20 MB one-stop alchemy workshop</em>.</p>',
      'coda.home':    '← Back to Home',
      'coda.guide':   'User Guide →',
      'coda.about':   'Why It Exists →'
    },
    ...
    chronicle: {
      ...
      'ch7.prose3':    '<strong>Harness Engineering</strong> — three pillars:<br>Context / Constraints / Entropy.<a href="https://yoursvas.app/harness/context" target="_blank" rel="noopener" class="inline-dot" aria-label="Harness Engineering"></a>',
