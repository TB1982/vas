(function () {
  ...
  window.VASI18n.en = {
    ...
    guide: {
      ...
      blLi1: '<strong>Drag an image near</strong><span class="g-badge-a" style="margin:0 4px 0 6px">All</span>—the toolbar opens like a Venus flytrap, catches what you\'re dragging. Release, and the image goes straight into the editor. If you were editing something else, it tucks that away and continues.',
      blLi2: '<strong>Copy a URL nearby</strong><span class="g-badge-t" style="margin:0 4px 0 6px">Tauri only</span>—the light unfolds, toast appears: "Found ⟨URL⟩—click to capture." One click. Screenshot begins.',
      blLi3: '<strong>Copy an image from your browser</strong><span class="g-badge-t" style="margin:0 4px 0 6px">Tauri only</span>—toast asks "paste image?" You confirm. Straight to the editor.',
      blNoteLabel: 'Summon',
