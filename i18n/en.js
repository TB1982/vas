(function () {
  ...
  window.VASI18n.en = {
    ...
    guide: {
      ...
      tipsA6: '<p>Grabbing a quick screenshot to share, jotting a note on it — macOS\'s built-in tool is plenty. Recording video, burst captures, building a user manual — Snagit / CleanShot X are the mature choices.</p><p>VAS solves a different problem. When you need to hand a screen over to an AI to read, redact whatever shouldn\'t end up as training data, and keep the whole flow gliding like running water — that\'s the scenario VAS has been optimizing for since day one.</p><p>You wouldn\'t use VAS to replace Snagit, just as Snagit can\'t replace VAS.</p>',
