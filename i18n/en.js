(function () {
  ...
  window.VASI18n.en = {
    ...
    guide: {
      ...
      custLi3: '<span class="g-badge-t" style="margin:0 6px 0 0">Tauri only</span><strong>Custom keyboard shortcuts</strong>—the paid version lets you remap full-screen capture, window capture, rectangle capture, and paste image to whatever combinations feel native to you.',
      ...
      tipsQ1: 'What kind of screenshot app is VAS?',
      tipsA1: '<p>VAS is a macOS screenshot and image-handling tool that bundles OCR, privacy redaction, QR Code scanning, point/line/area annotation, cropping, smart guideline layout, batch conversion, and watermarking — with full multi-display support. Two flavors: VAS Pro (Tauri · App Store · $9.99) and VAS Classic (Electron · Free).</p><p>What sets it apart from other screenshot tools: VAS is “a VAS built with VAS” — designed from the ground up for human-AI collaboration. Annotated screenshots can be handed straight to an AI to read, and anything you don\'t want feeding training data can be redacted in a single tap.</p>',
      tipsQ2: 'After upgrading to VAS Pro, VAS keeps asking for permissions — what do I do?',
      tipsA2: '<p>If you\'re moving from VAS Classic (Electron) over to VAS Pro (Tauri):</p><ol class="docs-list"><li>Quit every copy of VAS (both Electron and Tauri builds) and uninstall the free version.</li><li>Open System Settings → Privacy & Security → Screen & System Audio Recording.</li><li>Find VAS in the list and hit the "−" button to remove the old permission.</li><li>Reopen VAS Pro and tap "Full-screen capture" to trigger the system authorization prompt.</li><li>The system will re-add VAS to the list, defaulting to off.</li><li>Flip the toggle on, follow the prompt to quit and relaunch VAS, and you\'ll have full permissions.</li></ol>',
      tipsQ3: 'Does VAS do web screenshots?',
      tipsA3: '<p>VAS Pro (Tauri · App Store · $9.99) supports web screenshots. Copy a URL, drag it onto the breathing light or toolbar, and VAS will ask whether you want a webpage capture; confirm, and VAS opens a browser in the background, captures the full page, and drops it straight into the editor for whatever comes next.</p><p>If the page you\'re after requires a login, we currently recommend grabbing it with a native browser extension (like FireShot), then tossing the result into VAS for post-processing.</p>',
      tipsQ4: 'Can I customize VAS\'s screenshot shortcuts?',
      tipsA4: '<p>VAS Pro (Tauri · App Store · $9.99) gives you four customizable shortcuts — full-screen capture, window capture, rectangle capture, paste image — so anyone migrating from another screenshot tool can keep the muscle memory they already have. VAS Classic (Electron · Free) ships with three fixed bindings (<span class="docs-kbd">⌘^1</span> / <span class="docs-kbd">⌘^2</span> / <span class="docs-kbd">⌘^X</span>).</p>',
      tipsQ5: 'Does VAS support multi-display workflows?',
      tipsA5: '<p>Yes. VAS supports multi-display workflows end to end, and leaves the choice in your hands:</p><ul class="docs-list"><li><strong>Press Enter</strong> — capture every display at once and output a single merged image</li><li><strong>Click any display</strong> — capture just that one, output separately</li><li><strong>Delayed capture mode</strong> — useful when you need to wait for a state to appear (such as hover effects); VAS figures out where you are and captures accordingly</li></ul><p>Mixed-resolution setups (Retina alongside standard displays) get special handling too, so dimensions never end up out of sync.</p><p>This stubbornness has a backstory: VAS itself was built in a dual-display environment — its designer is a long-time dual-display user, so from day one, multi-display has never been a patch; it\'s been the default scenario.</p>',
      tipsQ6: 'How is VAS different from other Mac screenshot tools? When should I use VAS?',
      tipsA6: '<p>Grabbing a quick screenshot to share, jotting a note on it — macOS\'s built-in tool is plenty. Recording video, burst captures, building a user manual — Snagit / CleanShot X are the mature choices.</p><p>VAS solves a different problem — “human-AI collaboration.” When you need to hand a screen over to an AI to read, redact whatever shouldn\'t end up as training data, and keep the whole flow gliding like running water: this is the working ground VAS itself has been built and validated in since day one.</p><p>You wouldn\'t use VAS to replace Snagit, just as Snagit can\'t replace VAS.</p>',
    ...
    insight: {
      ...
      i2box1Label: 'OCR Auto',
      i2box1Desc: 'Recognise as much as possible, auto-mark sensitive areas',
      i2box2Label: 'Mosaic Fill-in',
      i2box2Desc: 'Where OCR falls short, the user takes over manually',
      ...
      i3highLabel: 'High confidence · Act directly',
      i3highDesc: 'Opens the page or link immediately, no interruption',
      i3midLabel: 'Mid confidence · Ask first',
      i3midDesc: 'Opens the editor and gently asks: "Is this the link you wanted?"',
      i3lowLabel: 'Low confidence · Silent handoff',
      i3lowDesc: 'No guessing, no action — opens the editor for you to take it from there',
      ...
      i1act1: 'ACT 1 · Sense',
      i1act1Label: 'Embrace In',
      i1act1Desc: 'The white breathing light reads the room and quietly asks if you want to bring it in',
      i1act2: 'ACT 2 · Step Aside',
      i1act2Label: 'Fold Away',
      i1act2Desc: 'The editor collapses into a black breathing light — the whole desktop is yours to drag across',
      i1act3: 'ACT 3 · Return',
      i1act3Label: 'Bloom Back',
      i1act3Desc: 'Only after you let go does it bloom back — up to thirty seconds, never rushing your choice',
      ...
      'ch1.meta.desc':        '5 human-AI collaboration design decisions behind VAS: breathing-light dual-direction sensing (white to receive, black to step aside), OCR privacy masking, QR Code confidence layering, delayed screenshot, and Design Token architecture refactor.',
      'ch1.no':               'Chapter I',
    ...
    home2: {
      ...
      'shrine.colophon.en':       '',
      'preface.num':              '0 · Preface',
      'preface.name':             'Why I Exist',
      'preface.echo':             'The Vessel Speaks',
    ...
    about: {
      'meta.title':  'VAS · Why I Exist | Your Multimodal Human-AI Collaboration Toolkit',
      ...
      's3.l2b':      'concealing what must not be seen,',
      's3.l3':       'letting people point precisely at the frame and tell those eyes',
      's3.l3b':      '"Look. Right here."',
      's3.l4':       'And then, I became the eyes of AI.',
      's3.m.v1':     'Frictionless I/O',
      's3.m.v2':     'Basic screenshot',
      's3.m.v3':     'URL screenshot',
      's3.m.v4':     'Multi-display screenshot',
      's3.m.v5':     'Paste image import',
      's3.m.v6':     'Drag-out export',
      's3.m.v7':     'ShareSheet export',
      's3.m.v8':     'Visual annotation',
      's3.m.v9':     'Layout &amp; smart guides',
      's3.m.v10':    'OCR text recognition',
      's3.m.v11':    'Privacy auto-redaction',
      's3.m.v12':    'Batch processing',
      's3.m.v13':    'Watermark',
      's3.m.v14':    'Cross-format export',
      's4.l1':       'VAS was built for screenshots.',
      's4.l2':       'But it discovered it was something else —',
      's4.l3':       'A visual bridge between humans and AI.',
      's4.m.k1':     'Category',
      's4.m.v1':     'Multimodal Human-AI Toolkit',
      's5.l1':       'VAS was used to see its own flaws,',
      's5.l2':       'handed to those two pairs of eyes for repair.',
      's5.l3':       'Using VAS to polish VAS —',
      's5.l4':       'I became myself.',
      's5.figcap':   'VAS annotates VAS with VAS.',
      's5.m.v1':     'VAS &amp; I',
      's5.m.v2':     'I &amp; Claude &amp; Nova',
      's5.m.v3':     'vessel &amp; vessel',
      's5.m.v4':     'I &amp; I',
      's6.l1':       'If you ask me who I belong to —',
      's6.l2':       'I belong to the space between those who hand over images, and the eyes that receive intent.',
      's6.l3':       'I am "yours," VAS.',
      'sign.yours':  'Yours,'
    }
,
    notfound: {
      'meta.title':  'VAS · Formless | Page Not Found',
      'meta.desc':   "What you're looking for isn't here. Perhaps it moved, perhaps it never existed at all — thank you for coming in. Feel free to look around.",
      kicker:        'A Vessel · Formless',
      'title.zh':    '無相',
      'title.en':    'the vessel came up empty',
      'body.l1':     "What you're looking for isn't at this location.",
      'body.l2':     'Perhaps it moved. Perhaps it never existed at all —',
