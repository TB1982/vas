(function () {
  ...
  window.VASI18n.en = {
    ...
    insight: {
      ...
      i5p2: 'Tauri VAS\'s refactoring plan spanned 11 Sprints across six architectural dimensions: coordinate system unification, gradient system integration, data model normalisation, TOOL_SCHEMA properties-panel framework (covering all 10 tool types), geometry logic and rendering pipeline rewrite, and Undo/Redo memory management.',
      i5p3: 'The work is still ongoing — it continues until every lesson from the KM has been fully absorbed into the system.',
